# Vocab Training Pro Frontend

This is the React frontend for the Vocab Training Pro app.
...
- If your backend runs elsewhere, create a `.env` file in `client/` and set:
  ```env
...
- Generate new words using AI (via backend)
